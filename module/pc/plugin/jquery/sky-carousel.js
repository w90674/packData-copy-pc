...
SKY.CarouselItem.createReflection = function (a, b, c) {
    var d = a.width(), g = a.height(), f = null;
    SKY.Utils.hasCanvasSupport() ? (f = $("<canvas>"), ctx = f.get(0).getContext("2d"), f.attr({
        ...
        0, d, b)) : (f = $("<img>"), f.attr({src: a.get(0).src}), f.css("filter", SKY.CarouselItem.getAlphaFilterStatement(c, b, g)));
    return f
};
...
SKY.Carousel.prototype = {
    ...
    setCurrentContent: function (a) {
        ...
        for (var a = this, b = this.settings, c = this.container, d = c.getLeft(), g = [],
                 f = 0; f < this.carouselItems.length; f++) {
            var e = this.carouselItems[f], h = d + e.x + b.itemWidth / 2 - this.centerX, k = Math.abs(h);
        ...
        function c(a) {
            var e = a.originalEvent, f = SKY.Utils.hasTouchSupport() ? e.changedTouches[0].clientX : a.clientX;
            a = SKY.Utils.hasTouchSupport() ? e.changedTouches[0].clientY : a.clientY;
            var e = Math.round(m / 20), h = d.closestItem.index();
            d.timer &&
            d.timer.start();
        ...
        if ("A" != a.target.nodeName) {
            var d = this, g = this.settings, f = a.originalEvent,
                e = startX = SKY.Utils.hasTouchSupport() ? f.targetTouches[0].clientX : a.clientX,
                h = SKY.Utils.hasTouchSupport() ? f.targetTouches[0].clientY : a.clientY, k = this.carouselItems.length,
                p = d.centerX - (g.selectedItemDistance + g.itemWidth / 2),
                l = p - (g.itemWidth * g.unselectedItemZoomFactor +
                    g.distance) * (k - 1), n = this.container.getLeft(), m = 0, t = !1, q = !1, u = !1;
            this.timer && this.timer.stop();
        ...
        if (!1 != $.support.leadingWhitespace) {
            var c = function () {
                ...
                a.dom.wrapper.animate({opacity: 1},
                    700);
        ...
        if (SKY.Utils.hasCanvasSupport()) {
            var f =
                $('<canvas class="sc-overlay" width="' + g + '" height="1"></canvas'), e = f.get(0).getContext("2d");
